...
INNER JOIN `warrenty` ON `product`.`warrenty_warrenty_id` = `warrenty`.`warrenty_id` WHERE `cart`.`user_id` = '" . $user["id"] . "'");
        ...
        <div class="col-12 border border-3 rounded-5 p-3 mb-2 d-flex justify-content-between">
            <div class="d-flex align-items-center col-5">
                ...
                <div class="ms-5">
                    ...
                    <p class="text-muted">Warrenty Time Period: <?php echo $d["warrenty_time_period"] ?></p>
